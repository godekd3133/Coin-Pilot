...
export const SCALPING_VARIANTS = {
  ...
  rebound_30: { minReboundPercent: 0.3 },
  rebound_35: { minReboundPercent: 0.35 },
  rebound_40: { minReboundPercent: 0.4 },
  cooldown_30m: { cooldownAfterLossMinutes: 30 },
  cooldown_60m: { cooldownAfterLossMinutes: 60 },
  cooldown_120m: { cooldownAfterLossMinutes: 120 },
  ...
  rebound_25_range_cap_08: { minReboundPercent: 0.25, maxSignalRangePercent: 0.8 },
  rebound_50_range_cap_08: { minReboundPercent: 0.5, maxSignalRangePercent: 0.8 },
  volume_15_rebound_50_range_cap_08: {
    minVolumeRatio: 1.5,
    minReboundPercent: 0.5,
    maxSignalRangePercent: 0.8
  },
  ...
  relax_volume_trend: { minVolumeRatio: 0, minTrendSlopePercent: -1.5 },
  relax_volume_highbreak: { minVolumeRatio: 0, requirePreviousHighBreak: false },
  relax_trend_highbreak: { minTrendSlopePercent: -1.5, requirePreviousHighBreak: false },
  relax_volume_trend_highbreak: {
    minVolumeRatio: 0,
  ...
  next_candle_followthrough: { requireNextCandleBullish: true },
